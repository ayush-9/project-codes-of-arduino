...
#define Finger_Rx 14 //D6
#define Finger_Tx 12 //D5
#define gsm_Rx 3 //this is D8
#define gsm_Tx 1 //this is gpio D7
...
SoftwareSerial mySerial1(gsm_Rx, gsm_Tx);
Adafruit_Fingerprint finger = Adafruit_Fingerprint(&mySerial);
//************************************************************************
/* Set these to your desired credentials. */
const char *ssid = "vivo 1609";  //ENTER YOUR WIFI SETTINGS
const char *password = "change...";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.43.36/biometricattendance/getdata.php"; //computer IP or the server domain
...
//  Serial.println(user_name);
  ...
  mySerial1.print("\r");
  delay(1000);                  
  mySerial1.print("AT+CMGF=1\r");    
  delay(1000);
  /*Replace XXXXXXXXXX to 10 digit mobile number &  ZZ to 2 digit country code*/
  mySerial1.print("AT+CMGS=\"+917000623709\"\r");    
  delay(1000);
  //The text of the message to be sent.
  mySerial1.print("Dear Parents ,your child Ayush is present today ");   
  delay(1000);
  ...
  delay(1000);
  /*Replace XXXXXXXXXX to 10 digit mobile number &  ZZ to 2 digit country code*/
  mySerial1.print("AT+CMGS=\"+918462009901\"\r");    
  delay(1000);
  //The text of the message to be sent.
  mySerial1.print("Dear Parents ,your child Vipul is present today ");   
  delay(1000);
  mySerial1.write(0x1A);
  delay(1000); 
      delay(1000);
  ...
  delay(1000);
  //The text of the message to be sent.
  mySerial1.print("Dear Parents ,your child Alex is present today ");   
  delay(1000);
  mySerial1.write(0x1A);
  delay(1000); 
      delay(1000);
...
//  Serial.println(user_name);
  ...
  delay(1000);
  //The text of the message to be sent.
  mySerial1.print("Dear Parents , your child Alex is leaving from college ");   
  delay(1000);
  mySerial1.write(0x1A);
  delay(1000); 
      delay(1000);
  ...
  delay(1000);
  //The text of the message to be sent.
  mySerial1.print("Dear Parents ,your child Vipul is leaving from college");   
  delay(1000);
  mySerial1.write(0x1A);
  delay(1000); 
      delay(1000);
  ...
  delay(1000);
  //The text of the message to be sent.
  mySerial1.print("Dear Parents ,your child Ayush is leaving from college ");   
  delay(1000);
  mySerial1.write(0x1A);
  delay(1000); 
      delay(1000);
